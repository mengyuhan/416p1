...
func main() {
	...
	// Add a triangle.
	shapeHash, blockHash, ink, err := canvas.AddShape(validateNum, blockartlib.PATH, "M 400 0 L 0 400 h 800 l -400 -400", "transparent", "red")
	if checkError(err) != nil {
		return
	}
	...
	// Add another line.
	shapeHash2, blockHash2, ink2, err := canvas.AddShape(validateNum, blockartlib.PATH, "M 0 0 L 300 0", "transparent", "blue")
	if checkError(err) != nil {
		return
	}
